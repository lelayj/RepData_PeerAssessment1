...
```{r plot1 histogram, fig.width= 6,fig.height= 6,echo=TRUE}
library(ggplot2)
...
```{r plot2 time series, fig.width= 10,fig.height= 9,echo=TRUE}
...
```{r plot3 new data set histogram, fig.width=6, fig.height=6, echo=TRUE}
library(ggplot2)
...
```{r plot4 means comparison, echo=TRUE}
...
**MAKING A PANEL PLOT:**
```{r plot5 panel, fig.width= 10,fig.height= 9,echo=TRUE}
